...
export const DirectionsService = {
    //getDrivingDistance: async(origin: Coordinates, destination: Coordinates) => {
...
const getURL = (origin: Coordinates) : string => {
  ...
  return BASE_URL + `${origin.latitude},${origin.longitude}&destinations=${destinations}&key=${process.env.GOOGLE_API_KEY}`
} 
